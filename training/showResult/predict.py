...
if __name__ == "__main__":
    ...
    with open("../conf/train_conf.json") as conf:
        ...
        args.checkpoint = args.checkpoint[:-3] + '_' + str(args.expId) + args.checkpoint[-3:]
        args.best_model = args.best_model[:-3] + '_' + str(args.expId) + args.best_model[-3:]
        args.best_cluster_model = args.best_cluster_model[:-3] + '_' + str(args.expId) + args.best_cluster_model[-3:]
        args.cluster_model = args.cluster_model[:-3] + '_' + str(args.expId) + args.cluster_model[-3:]
